...
# we can use a barplot to visualize the distribution:
barplot(table(Y),
        col = viridis(1),
        border = F,
...
Now it's your turn. You will run similar models and calculate first differences between (a) autocracies and democracies, and (b) autocracies and anocracies, to look at the substantive effects.
